...
sed -i "s/^GR_ID_LETTER=.*/GR_ID_LETTER='[abcdefghijklmnopqrstuvwxyz]'/" scripts/lib.sh
sed -i "s/^GR_ID_DIGIT=.*/GR_ID_DIGIT='[0123456789]'/" scripts/lib.sh
sed -i "s/^GR_ID_ANY=.*/GR_ID_ANY='[abcdefghijklmnopqrstuvwxyz0123456789]'/" scripts/lib.sh
